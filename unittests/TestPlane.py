...
class TestPlane(unittest.TestCase):
    def test_intersect_plane_ray(self):
        ...
        intersection_point = plane.intersect_with_ray(np.array([0., 0., 10.]), np.array([0., -1., -1.]))
    ...
    def test_intersect_planes(self):
        ...
        np.testing.assert_array_equal(line[0], np.array([1., 0., 0.]))
        np.testing.assert_array_equal(line[1], np.array([0., 1., 0.]))
